...
,
 '11. No One Else Like You - Adam Levine': {'video_url': 'https://www.youtube.com/watch?v=xYWZfCjK8wE',
                                            'bg': (
                                                ...
                                                '\n'
                                                '    <p style="font-size:1.35rem; line-height:2.0; color:#1e293b;">\n'
                                                '        Adam Levine의 <b>No One Else Like You</b>는 영화 <i>Begin Again</i>에 나오는 노래로,\n'
                                                '        마음속에 특별한 사람이 있지만 그 마음을 쉽게 드러내지 못하는 화자의 솔직한 감정을 담고 있습니다.\n'
                                                '        제목의 <b>no one else like you</b>는 “너 같은 사람은 아무도 없어”라는 뜻으로,\n'
                                                '        상대가 자신에게 얼마나 특별한 존재인지 보여 줍니다.\n'
                                                '    </p>\n'
                                                '\n'
                                                '    <p style="font-size:1.35rem; line-height:2.0; color:#1e293b;">\n'
                                                '        영화 <i>Begin Again</i>은 음악을 통해 상처 입은 사람들이 다시 삶을 시작하는 이야기입니다.\n'
                                                '        주인공 그레타는 남자친구 데이브와 함께 뉴욕에 오지만,\n'
                                                '        데이브가 가수로 성공하면서 두 사람의 관계는 점점 멀어집니다.\n'
                                                '        결국 데이브의 배신으로 그레타는 큰 상처를 받게 됩니다.\n'
                                                '    </p>\n'
                                                '\n'
                                                '    <p style="font-size:1.35rem; line-height:2.0; color:#1e293b;">\n'
                                                '        한편, 과거에는 잘나가던 음반 프로듀서였지만 지금은 일과 가정 모두에서 어려움을 겪고 있던 댄은\n'
                                                '        우연히 작은 바에서 그레타의 노래를 듣게 됩니다.\n'
                                                '        그는 그레타의 음악에서 진심과 가능성을 발견하고, 함께 음반을 만들자고 제안합니다.\n'
                                                '        하지만 이들은 돈도, 제대로 된 스튜디오도 없기 때문에 뉴욕 거리, 골목, 지하철역, 건물 옥상 등\n'
                                                '        도시 곳곳을 녹음 장소로 삼아 음악을 만들어 갑니다.\n'
                                                '    </p>\n'
                                                '\n'
                                                '    <p style="font-size:1.35rem; line-height:2.0; color:#1e293b;">\n'
                                                '        이 과정에서 그레타는 이별의 상처를 조금씩 극복하고,\n'
                                                '        댄도 잃어버렸던 열정과 삶의 방향을 되찾습니다.\n'
                                                '        그래서 이 영화는 단순한 사랑 이야기가 아니라,\n'
                                                '        상처받은 사람들이 음악을 통해 자신을 회복하고 다시 시작하는 이야기라고 볼 수 있습니다.\n'
                                                '        제목 <b>Begin Again</b>처럼, 실패와 이별 뒤에도 삶은 다시 시작될 수 있다는 메시지를 담고 있습니다.\n'
                                                '    </p>\n'
                                                '\n'
                                                '    <p style="font-size:1.35rem; line-height:2.0; color:#1e293b;">\n'
