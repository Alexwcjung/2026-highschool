...
,
 '8. My Heart Will Go On - Celine Dion': {
    'video_url': 'https://www.youtube.com/watch?v=3gK_2XdjOdY',
    'bg': '\n'
          ...
          '        멀리 떨어져 있거나 더 이상 만날 수 없는 사람도 마음속에서는 계속 살아 있다는 메시지를 담은 노래입니다.\n'
          '    </p>\n'
          '\n'
          '    <p style="font-size:1.35rem; line-height:2.0; color:#1e293b;">\n'
          '        노래 속 화자는 꿈속에서 사랑하는 사람을 보고 느낍니다.\n'
          '        두 사람 사이에는 먼 거리와 공간이 있지만, 그 사랑은 사라지지 않고 마음속에 남아 있습니다.\n'
          '        그래서 <b>my heart will go on</b>이라는 표현은 단순히 심장이 계속 뛴다는 뜻이 아니라,\n'
          '        사랑과 기억이 계속 이어진다는 의미로 이해할 수 있습니다.\n'
          '    </p>\n'
          '\n'
          '    <p style="font-size:1.35rem; line-height:2.0; color:#1e293b;">\n'
          '        이 노래는 상실과 그리움을 다루지만, 완전히 슬프기만 한 노래는 아닙니다.\n'
          '        사랑했던 기억이 한 사람의 삶 속에서 계속 힘이 되고,\n'
          '        마음속에 안전하게 남아 있다는 믿음을 보여 줍니다.\n'
          '    </p>\n'
          '\n'
          '    <p style="font-size:1.35rem; line-height:2.0; color:#1e293b;">\n'
          ...
          '    ',
    'lyrics': [
        ('Every night in my dreams / I see you, I feel you', '매일 밤 꿈속에서 / 나는 너를 보고, 너를 느껴'),
        ('That is how I know you go on', '그래서 나는 네가 계속 존재한다는 것을 알아'),
        ('Far across the distance / And spaces between us', '우리 사이의 먼 거리와 / 공간을 넘어'),
        ...
        ("Once more, you open the door / And you're here in my heart", '다시 한 번, 너는 문을 열고 / 내 마음속에 있어'),
        ('And my heart will go on and on', '그리고 내 마음은 계속 이어질 거야'),
        ('Love can touch us one time / And last for a lifetime', '사랑은 한 번 우리에게 닿아 / 평생 지속될 수 있어'),
        ("And never let go 'til we're gone", '그리고 우리가 사라질 때까지 절대 놓지 않아'),
        ('Love was when I loved you / One true time I’d hold to', '사랑은 내가 너를 사랑했던 그때였어 / 내가 붙잡고 싶은 단 하나의 진실한 순간'),
        ...
        ('And I know that my heart will go on', '그리고 나는 내 마음이 계속 이어질 것을 알아'),
        ("We'll stay forever this way", '우리는 영원히 이렇게 머물 거야'),
        ('You are safe in my heart and / My heart will go on and on', '너는 내 마음속에 안전하게 있고 / 내 마음은 계속 이어질 거야')
    ],
    'quiz': [
        {'q': '1. 이 노래에서 화자는 매일 밤 어디에서 사랑하는 사람을 보나요?', 'options': ['학교에서', '꿈속에서', '바닷가에서', '기차 안에서'], 'answer': '꿈속에서'},
        {'q': '2. 화자는 사랑하는 사람이 어디에 있다고 느끼나요?', 'options': ['내 마음속에', '교실 뒤에', '먼 도시의 가게에', '배 위의 식당에'], 'answer': '내 마음속에'},
        {'q': "3. 'Near, far, wherever you are'의 의미로 가장 알맞은 것은 무엇인가요?", 'options': ['가까이 있든 멀리 있든 네가 어디에 있든', '항상 가까이에만 있어야 한다', '멀리 가면 잊어야 한다', '길을 잃었다'], 'answer': '가까이 있든 멀리 있든 네가 어디에 있든'},
        {'q': "4. 'My heart will go on'은 어떤 의미에 가깝나요?", 'options': ['내 마음과 사랑은 계속 이어질 것이다', '나는 빨리 달릴 것이다', '나는 문을 닫을 것이다', '나는 노래를 멈출 것이다'], 'answer': '내 마음과 사랑은 계속 이어질 것이다'},
        {'q': '5. 이 노래의 중심 감정으로 가장 알맞은 것은 무엇인가요?', 'options': ['그리움과 영원한 사랑', '분노와 복수', '시험에 대한 걱정', '승리의 기쁨'], 'answer': '그리움과 영원한 사랑'},
        {'q': "6. 'Love can touch us one time and last for a lifetime'의 의미는 무엇인가요?", 'options': ['사랑은 한 번 닿아도 평생 남을 수 있다', '사랑은 항상 바로 사라진다', '사랑은 한 번도 중요하지 않다', '사랑은 시험 점수와 같다'], 'answer': '사랑은 한 번 닿아도 평생 남을 수 있다'},
        {'q': "7. 'There’s nothing I fear'는 어떤 의미인가요?", 'options': ['나는 두려운 것이 없다', '나는 모든 것이 무섭다', '나는 아무것도 보지 못한다', '나는 노래를 싫어한다'], 'answer': '나는 두려운 것이 없다'},
        {'q': '8. 이 노래가 전하려는 메시지로 가장 알맞은 것은 무엇인가요?', 'options': ['사랑과 기억은 마음속에서 계속 이어질 수 있다', '사람은 절대 꿈을 꾸지 않는다', '멀리 있으면 모든 감정은 사라진다', '사랑은 항상 쉬운 일이다'], 'answer': '사랑과 기억은 마음속에서 계속 이어질 수 있다'}
    ],
    'key_expressions': [
        ('In my dreams', '내 꿈속에서'),
