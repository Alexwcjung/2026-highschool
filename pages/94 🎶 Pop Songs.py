...
if "1. Let It Go" in song_choice:
    ...
    questions = [
        ...
        ("6. 이 노래의 전체적인 핵심 키워드는?", ["자유와 경이로움", "두려움"], "자유와 경이로움")
    ]
    ...
    questions = [
        ...
        ("3. 'Afraid'하지 않는 절대적인 조건은?", ["당신이 곁에 있을 때", "돈이 많을 때"], "당신이 곁에 있을 때"),
        ("4. 'Tumble and fall'은 무엇을 의미하나요?", ["심각한 시련/재앙", "즐거운 축제"], "심각한 시련/재앙"),
        ("5. 'Crumble'의 의미는?", ["허물어지다", "치솟다"], "허물어지다"),
        ("6. 'Stand by me'의 가장 알맞은 해석은?", ["내 곁을 지켜줘", "내 옆에 서서 기다려"], "내 곁을 지켜줘")
    ]
    ...
    questions = [
        ("1. 화자가 기다린 시간은?", ["해가 뜰 때까지", "밤 12시까지"], "해가 뜰 때까지"),
        ("2. 화자의 현재 감정은?", ["후회와 의문", "자신감"], "후회와 의문"),
        ("3. 'House of fun'에 남겨진 대상은?", ["You(상대방)", "I(나)"], "You(상대방)"),
        ("4. 'Fly away'는 무엇을 뜻하나요?", ["현실 회피/자유", "비행기 여행"], "현실 회피/자유"),
...
with tab3:
    ...
    if st.session_state.show_q3_result:
        ...
        if all_correct: st.balloons(); st.success("축하합니다! 1절 가사 전체 순서를 맞혔습니다.")
