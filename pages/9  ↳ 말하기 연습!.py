...
st.info("사용 방법: ① 문법 선택 → ② 한국어 문장 보고 영어로 말하기 → ③ 정답 보기 → ④ 발음 듣기")


# =========================================================
# 브라우저 발음 재생 함수
# =========================================================
def speak_button(text, button_text="🔊 발음 듣기"):
...
speaking_questions = [
    ...
    {
        "category": "💪 can 조동사",
        "korean": "그는 영어를 말할 수 없다.",
        "sentence": "He can't speak English."
    },
    {
        "category": "💪 can 조동사",
        "korean": "너는 수영할 수 있니?",
...
if "last_question_key_expansion" not in st.session_state:
    st.session_state.last_question_key_expansion = question_key

if "show_answer_expansion" not in st.session_state:
    st.session_state.show_answer_expansion = False

if st.session_state.last_question_key_expansion != question_key:
    st.session_state.show_answer_expansion = False
    st.session_state.last_question_key_expansion = question_key
...
# =========================================================
if st.button("✅ 정답 보기"):
    st.session_state.show_answer_expansion = True

if st.session_state.show_answer_expansion:
    st.markdown(
        f"""
    ...
    st.markdown("### 🔊 원어민 발음")
    speak_button(current_q["sentence"])
