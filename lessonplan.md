...
| 📖 Reading Learning | Letter Writing with Translation Support | 4 min | Students write a short guided letter or response based on the reading passage. They may use Google Translation support to draft or revise their sentences. | Provides writing support, encourages students to check and improve translated sentences, and gives simple feedback. | Letter writing activity and Google Translation support |
